...
dv.taskList(dv.pages().file.tasks 
  .where(t => !t.completed)
  .where(t => t.text.includes("2023-08-11")))
...
### Dreams
- Had a bit of a weird one today. Almost got back together with Sofi, who transformed into Emma mid make-out??? Dream analysts gotta look into this one. 
#### Log
- MOVE IN DAYYYY
- This has been absolutely amazing. 
- Was a bit frustrated by the HDMI, but I got over it. Overall, very excited. 
- Room is done done, and I gotta say, I love it
