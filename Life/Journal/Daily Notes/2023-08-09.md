...
dv.taskList(dv.pages().file.tasks 
  .where(t => !t.completed)
  .where(t => t.text.includes("2023-08-09")))
...
### Dreams
- Parked on the 595 after car issues
- It started collapsing
- Literally vaulted a double ended collapse
- Fell through after that
- Tungsten window tool clutch up
- Swam to shore, flexed on Mia
#### Log
- Got some good obsidian stuff done
- I was up early!!!
#### Daily Resources
